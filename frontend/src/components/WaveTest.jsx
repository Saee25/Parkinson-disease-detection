...
const WaveTest = ({ onBack }) => {
  ...
  const handleAnalyze = () => {
    if (inputType === 'physical') {
        ...
        saveTestResult('waveFile', selectedFile);
    } else {
          ...
          {inputType === 'digital' ? (
              ...
              <div className="flex flex-col items-center">
                  ...
                  >
                      {previewUrl ? (
                          <>
                            <img src={previewUrl} alt="Wave Preview" className="w-full h-full object-contain" />
                          ...
                          <>
                            ...
                            <span className="text-slate-500 font-medium text-center px-6">Click to upload your wave drawing photo</span>
                          </>
                      )}
                  </div>
                  <input 
